///********************************************************************************************************************///
/// Code adapted from (https://github.com/marcouguccioni/Monte_Carlo_Instantons/tree/main/Instanton_Monte_Carlo_Codes) ///
///********************************************************************************************************************///
...
double pif = 3.1415926535897932384626433832795;
...
int main()
{
    ...
    for (int fIncrement = 0; fIncrement <= 80; fIncrement++) {
        double f = 0.025 + 0.025 * fIncrement;
        int nmax = 1000;
